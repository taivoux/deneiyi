...
<body class = "container-fluid">
	...
	<main>
		<div class= "section-1 row center-1">
			...
			<div class="col-5 center-2">
				
					<a href="#"> <img class = "img-1" src="img/background.jpg"></a>
			</div>
		...
		<div class= "section-3 row center-1">
			...
			<div class="col-12">
				<div class="row center-2">
					...
					<div class="col-3">
						<a href="#"><img src="img/bst-4.jpg"></a>
					</div>
					
					
					<!-- <img src="img/bst-2.jpg">
					<img src="img/bst-3.jpg">
					<img src="img/bst-4.jpg">
					 -->
				</div>
			...
			<div class="col-12">
				<div class="row">
					<h4 class="section-3-content-2" > XEM THÊM >> </h4>
		...
		<div class= "section-7 row center-1">
			<div class="col-12">
				<div class="row center-2 section-7-content">
				...
				<div class="row center-2">
					<img src="img/photo-instagram.jpg" style="width: 85%">
